...
import { faCalendarAlt } from "@fortawesome/free-solid-svg-icons"; // Chose an icon to represent time duration

const PolicyTermInfo: React.FC = () => {
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center p-4">
      ...
      <div className="bg-white shadow-2xl rounded-lg p-10 w-full max-w-2xl space-y-6 relative z-10 border-2 border-blue-200">
        ...
        <p className="text-lg text-gray-600 leading-relaxed">
          In auto insurance, the policy term refers to the duration of time the
          insurance coverage is effective. It's the period during which the
          insurance company agrees to provide coverage as outlined in the policy
          document.
        </p>
        ...
        <div className="relative group transition-shadow duration-300 rounded-md">
          ...
          <p className="text-gray-700 leading-relaxed bg-opacity-50 px-4 py-2 border rounded-md">
            John purchases a car insurance policy with a term of 12 months,
            starting from January 1st. This means he is covered under the policy
        ...
        <div className="relative group transition-shadow duration-300 rounded-md">
          <label
            ...
            htmlFor="why"
          >
            Why Is Understanding Policy Term Important? 🤔
          </label>
          <p className="text-gray-700 leading-relaxed bg-opacity-50 px-4 py-2 border rounded-md">
            Knowing your policy term is crucial to ensure you have continuous
            coverage. Letting a policy lapse or expire without renewal can leave
            you unprotected and potentially result in higher premiums when you
            do seek a new policy.
          </p>
        </div>
