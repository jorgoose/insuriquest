...
import { faGavel } from "@fortawesome/free-solid-svg-icons"; // Changed the icon to represent "judgment" or "responsibility"

const AtFaultInfo: React.FC = () => {
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center p-4">
      ...
      <div className="bg-white shadow-2xl rounded-lg p-10 w-full max-w-2xl space-y-6 relative z-10 border-2 border-blue-200">
        ...
        <p className="text-lg text-gray-600 leading-relaxed">
          In the context of auto insurance, being "at-fault" refers to the party
          responsible for causing an accident or damage. The determination of
          fault can affect claims, premiums, and even legal ramifications.
        </p>
        ...
        <div className="relative group transition-shadow duration-300 rounded-md">
          ...
          <p className="text-gray-700 leading-relaxed bg-opacity-50 px-4 py-2 border rounded-md">
            Suppose you're driving above the speed limit and rear-end another
            vehicle stopped at a traffic light. In this case, you'd likely be
        ...
        <div className="relative group transition-shadow duration-300 rounded-md">
          <label
            ...
            htmlFor="why"
          >
            Why Is the At-Fault System Important? 🤔
          </label>
          <p className="text-gray-700 leading-relaxed bg-opacity-50 px-4 py-2 border rounded-md">
            Understanding who is at-fault in an accident can determine which
            insurance company is responsible for paying out a claim.
            Furthermore, the at-fault driver might see a rise in their premiums
            or even face legal consequences depending on the severity of the
            incident.
          </p>
        </div>
